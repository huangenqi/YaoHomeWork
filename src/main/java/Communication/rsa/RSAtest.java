...
public class RSAtest {
    ...
    public static SecretKey generateKey(BigInteger p, BigInteger q) {
        ...
        System.out.println("x:"+x.toByteArray().length);
    ...
    public static void main(String[] args) {
        SecretKey secretKey = RSAtest.generateKey();
        //明文内容不要超过1024位,超过后需要分段加密
        String text = "Hello world";
        String chipper = RSAtest.encrypt(text, secretKey.getPublicKey());
        ...
        System.out.println("加密后:\n" +
                ...
                + "\n"
                + chipper);
        String origin = RSAtest.decrypt(chipper, secretKey.getPrivateKey());
